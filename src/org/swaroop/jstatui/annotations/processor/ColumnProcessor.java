...
public class ColumnProcessor extends AbstractProcessor {
	 ...
	 * 
	 * @param filer
	 *            An object of {@link javax.annotation.processing.Filer Filer}
	 *            to write out the Bean class
	 * @param elements
	...
	private void generateFullBeanClass(Filer filer,
		...
		try {
			...
			writer.write("/**\n  * This bean corresponds to " + tableName
					+ " table\n  *\n  ");
			writer.write("* @author {@link org.swaroop.jstatui.annotations.processor.ColumnProcessor ColumnProcessor}\n");
			writer.write("  *\n  */\n");
			...
			for (Element e : elements) {
				...
				writer.write("\t */\n");
				writer.write("\tpublic " + e.asType().toString() + " get"
						+ methodName + "() {\n");
			...
			writer.write("\t\tif (" + primaryField + " != other."
					+ primaryField + ")\n");
			writer.write("\t\t\treturn false;\n");
			writer.write("\t\treturn true;\n");
			writer.write("\t}\n\n");
